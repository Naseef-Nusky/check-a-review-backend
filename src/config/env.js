...
export const env = {
  ...
  // Sign in with Apple audiences: iOS bundle ID, Expo Go, and optional web Services ID
  APPLE_CLIENT_ID: process.env.APPLE_CLIENT_ID || 'com.checkareview.mobile,host.exp.Exponent',
