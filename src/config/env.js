...
export const env = {
  ...
  SQUARE_STARTER_AMOUNT_CENTS: process.env.SQUARE_STARTER_AMOUNT_CENTS || '118800',
  SQUARE_PLUS_AMOUNT_CENTS: process.env.SQUARE_PLUS_AMOUNT_CENTS || '382800',
  SQUARE_PREMIUM_AMOUNT_CENTS: process.env.SQUARE_PREMIUM_AMOUNT_CENTS || '958800',
